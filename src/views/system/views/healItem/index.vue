<template>
  <div class="skuList_container">
    ...
    <!-- 表格 -->
    <el-table :data="table.HealItemList" @selection-change="selectWarehouseSkuRows" highlight-current-row border row-style="height:40px">
      ...
      <el-table-column fixed="right" label="编辑" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="updateDiolog(scope.row)" icon="el-icon-check">保存数据</el-button>
          </template>
        </el-table-column>
    </el-table>
    <!-- 分页 -->
