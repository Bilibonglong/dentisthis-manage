<template>
    <div class="skuList_container">
      ...
      <!-- 表格 -->
      <el-table :data="table.financeList" @selection-change="selectWarehouseSkuRows" highlight-current-row border row-style="height:40px">
  ...
  export default {
    ...
    methods: {
      ...
      async GetRevenueOrderList() {
        await this.$api.finance.GetRevenueOrderList().then((res) => {
